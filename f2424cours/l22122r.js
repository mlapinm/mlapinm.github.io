...
"So in this video, we'll talk about gradient descent for minimizing some arbitrary function J",
"and then in later videos, we'll take this algorithm and apply it specifically to the cost function J that we have defined for linear regression.",
"So here's the problem setup.",
"Going to assume that we have some function J(theta 0, theta 1)",
"maybe it's the cost function from linear regression,",
...
"So imagine, if you have a function that's a function of J, as theta 0, theta 1, theta 2, up to say some theta n,",
"and you want to minimize theta 0. You minimize over theta 0 up to theta n of this J of theta 0 up to theta n.",
"And it turns our gradient descent is an algorithm for solving this more general problem.",
...
"Doesn't really matter what they are, but a common choice would be we set theta 0 to 0, and set theta 1 to 0,",
...
"So notice the axes,",
"this is theta 0, theta 1 on the horizontal axes and J is the vertical axis",
...
"and I want us to imagine that you are physically standing at that point on the hill, on this little red hill in your park.",
...
"If I wanna go down, so I wanna physically walk down this hill as rapidly as possible.",
...
"You're gonna, again, look all around and say what direction should I step in order to take a little baby step downhill?",
"And if you do that and take another step, you take a step in that direction. And then you keep going.",
"From this new point you look around, decide what direction would take you downhill most quickly.",
...
"So if you had started this first point, you would've wound up at this local optimum, but if you started just at a slightly different location, you would've wound up at a very different local optimum.",
...
"we're going to update my parameter theta j by taking theta j and subtracting from it alpha times this term over here, okay?",
"So let's see, there's lot of details in this equation so let me unpack some of it.",
"First, this notation here, :=, gonna use := to denote assignment, so it's the assignment operator.",
...
"Whereas in contrast, if I use the equal sign and I write a equals b, then this is a truth assertion. Okay?",
...
"The right hand side, this is asserting, I'm just making a claim that the values of a and b are the same,",
"and so whereas you can write a := a + 1, that means increment a by 1, hopefully I won't ever write a = a + 1 because that's just wrong.",
"a and a + 1 can never be equal to the same values. Okay?",
...
"So if alpha is very large, then that corresponds to a very aggressive gradient descent procedure",
"where we're trying take huge steps downhill and if alpha is very small, then we're taking little, little baby steps downhill.",
...
"Now, there's one more subtlety about gradient descent which is in gradient descent",
"we're going to update, you know, theta 0 and theta 1, right?",
...
"What I mean by that is that in this equation, we're gonna update theta 0 := theta 0 minus something, and update theta 1 := theta 1 minus something.",
"And the way to implement is you should compute the right hand side, right?",
"Compute that thing for theta 0 and theta 1 and then simultaneously, at the same time, update theta 0 and theta 1, okay?",
"So let me say what I mean by that.",
"This is a correct implementation of gradient descent meaning simultaneous update.",
"So I'm gonna set temp0 equals that, set temp1 equals that so basic compute the right-hand sides,",
"and then having computed the right-hand sides and stored them into variables temp0 and temp1, I'm gonna update theta 0 and theta 1 simultaneously because that's the correct implementation.",
