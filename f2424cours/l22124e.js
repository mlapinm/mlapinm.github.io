...
"Sum from y equals 1 though m. Of this squared error cost function term.",
"And all I did here was I just, you know plug in the definition of the cost function there.",
"And simplifying a little bit more, this turns out to be equal to this.",
"Sigma i equals one through m of theta zero plus theta one x i minus Yi squared.",
"And all I did there was I took the definition for my hypothesis and plugged it in there.",
"And turns out we need to figure out what is this partial derivative for two cases for J equals 0 and J equals 1.",
...
"Minus Y(i) times X(i).",
"Okay and computing these partial derivatives, so we're going from this equation.",
"Right going from this equation to either of the equations down there.",
"Computing those partial derivative terms requires some multivariate calculus.",
...
"So here's gradient descent for linear regression which is gonna repeat until convergence, theta 0 and theta 1 get updated as you know this thing minus alpha times the derivative term.",
"So this term here.",
...
"And just as a quick reminder, you must, when implementing gradient descent.",
...
"And I'm not gonna give the formal definition for what is a convex function, C, O, N, V, E, X.",
...
"Because there are no other local optimum, global optimum.",
"So now let's see this algorithm in action.",
"As usual, here are plots of the hypothesis function and of my cost function j.",
"And so let's say I've initialized my parameters at this value.",
"Let's say, usually you initialize your parameters at zero, zero. Theta zero and theta equals zero.",
"But for the demonstration, in this physical infrontation I've initialized you know, theta zero at 900 and theta one at about -0.1 okay.",
"And so this corresponds to h(x)=-900-0.",
"1x, [the intercept should be +900] is this line, out here on the cost function.",
"Now, if we take one step in gradient descent, we end up going from this point out here, over to the down and left, to that second point over there.",
"And you notice that my line changed a little bit, and as I take another step of gradient descent, my line on the left will change.",
"Right?",
"And I've also moved to a new point on my cost function.",
...
"And if you look on the left, this corresponds with hypotheses.",
"That seem to be getting to be better and better fits to the data until eventually I've now wound up at the global minimum and this global minimum corresponds to this hypothesis, which gets me a good fit to the data.",
...
"And it turns out in machine learning I don't know I feel like us machine learning people were not always great at giving names to algorithms.",
"But the term batch gradient descent refers to the fact that in every step of gradient descent, we're looking at all of the training examples.",
"So in gradient descent, when computing the derivatives, we're computing the sums [INAUDIBLE].",
"So ever step of gradient descent we end up computing something like this that sums over our m training examples and so the term batch gradient descent refers to the fact that we're looking at the entire batch of training examples.",
"And again, it's really not a great name, but this is what machine learning people call it.",
"And it turns out that there are sometimes other versions of gradient descent that are not batch versions, but they are instead.",
"Do not look at the entire training set but look at small subsets of the training sets at a time.",
"And we'll talk about those versions later in this course as well.",
"But for now using the algorithm we just learned about or using batch gradient descent you now know how to implement gradient descent for linear regression.",
"So that's linear regression with gradient descent.",
"If you've seen advanced linear algebra before, so some of you may have taken a class in advanced linear algebra.",
"You might know that there exists a solution for numerically solving for the minimum of the cost function j without needing to use an iterative algorithm like gradient descent.",
"Later in this course we'll talk about that method as well that just solves for the minimum of the cost function j without needing these multiple steps of gradient descent.",
...
"The first one to tell you about a generalization of the gradient descent algorithm that will make it much more powerful.",
"And I guess I'll tell you about that in the next video.",
]