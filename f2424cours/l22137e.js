...
"And because these two matrices are not of the same dimension, you know, this is an error, so you cannot add these two matrices and, you know, their sum is not well-defined.",
...
"What, two times three is six, 3 times 3 is 9, and let's see,",
"I'm going to stop changing colors again.",
...
"And you notice, again, this is a 3 by 2 matrix and the result is a matrix of the same dimension. This is a 3 by 2, both of these are 3 by 2 dimensional matrices.",
"And by the way, you can write multiplication, you know, either way.",
"So, I have three times this matrix.",
"I could also have written this matrix and 0, 2, 5, 3, 1, right.",
"I just copied this matrix over to the right. I can also take this matrix and multiply this by three.",
...
"4, 0, 6, 3 and so, you can figure the answer, the result of this product is, one quarter times four is one, one quarter times zero is zero.",
...
"And so that's the results of computing this matrix divided by four. Vectors give you the result.",
...
"And this is, you know, another scalar multiplication. Or more like scalar division, I guess. It really just means one zero times this. And so if we evaluate these two operations first, then what we get is this thing is equal to, let's see, so three times that vector is three, twelve, six, plus my vector in the middle which is a 005 minus one, zero, two-thirds, right?",
"And again, just to make sure we understand what is going on here, this plus symbol, that is matrix addition, right?",
"I really, since these are vectors, remember, vectors are special cases of matrices, right?",
"This, you can also call this vector addition",
"This minus sign here, this is again a matrix subtraction, but because this is an n by 1, really a three by one matrix, that this is actually a vector, so this is also vector, this column.We call this matrix a vector subtraction, as well.",
"OK?",
"And finally to wrap this up.",
"This therefore gives me a vector, whose first element is going to be 3+0-1, so that's 3-1, which is 2.The second element is 12+0-0, which is 12.And the third element of this is, what, 6+5-(2/3), which is 11-(2/3), so that's 10 and one-third and see,",
"you close this square bracket.",
