...
"Let's start by talking about matrix inverse,",
"and as usual we'll start by thinking about how it relates to real numbers.",
...
"It turns out that real numbers have this property that very number have an, that each number has an inverse,",
"for example, given the number three,",
"there exists some number, which happens to be three inverse so that that number times gives you back the identity element one.",
...
"the product is equal to the identity element one again.",
...
"Here's the idea: If A is a n by n matrix, and it has an inverse, I will say a bit more about that later,",
"then the inverse is going to be written A to the minus one",
"and A times this inverse, A to the minus one, is going to equal to A inverse times A, is going to give us back the identity matrix.",
"Okay?",
...
"So this is a two by two matrix, so it's a square matrix",
"and so this may just could have an and it turns out that I happen to know the inverse of this matrix is zero point four, minus zero point one, minus zero point zero five, zero zero seven five.",
...
"Set my matrix A to be equal to that matrix on the left,",
"type three four two sixteen, so that's my matrix A right.",
"This is matrix 34, 216",
"that I have down here on the left.",
...
"So let me just write, inverse of A equals P inverse of A",
"over that I can now just verify that A times A inverse the identity is, type A times the inverse of A",
"and the result of that is this matrix and this is one one on the diagonal and essentially ten to the minus seventeen, ten to the minus sixteen,",
"so Up to numerical precision, up to a little bit of round off error that my computer had in finding optimal matrices",
"and these numbers off the diagonals are essentially zero",
...
"If a definition that the inverse of a matrix is, I had this caveat first it must always be a square matrix,",
"it had this caveat, that if A has an inverse, exactly what matrices have an inverse is beyond the scope of this linear algebra",
"for review that one intuition you might take away that just as the number zero doesn't have an inverse, it turns out that if A is say the matrix of all zeros, then this matrix A also does not have an inverse",
"because there's no matrix there's no A inverse matrix so that this matrix times some other matrix will give you the identity matrix so this matrix of all zeros, and there are a few other matrices with properties similar to this.",
"That also don't have an inverse.",
"But it turns out that in this review I don't want to go too deeply into what it means matrix have an inverse but it turns out for our machine learning application this shouldn't be an issue",
"or more precisely for the learning algorithms where this may be an to namely whether or not an inverse matrix appears and I will tell when we get to those learning algorithms just what it means for an algorithm to have or not have an inverse and how to fix it in case.",
...
"So suppose I have matrix A,",
"if I compute the transpose of A, that's what I get here on the right.",
"This is a transpose which is written and A superscript T,",
"and the way you compute the transpose of a matrix is as follows.",
...
"And another way of thinking about how the computer transposes is as",
"if you're taking this sort of 45 degree axis and you are mirroring or you are flipping the matrix along that 45 degree axis.",
"so here's the more formal definition of a matrix transpose.",
"Let's say A is a m by n matrix.",
"And let's let B equal A transpose and so BA transpose like so.",
"Then B is going to be a n by m matrix with the dimensions reversed so here we have a 2x3 matrix.",
"And so the transpose becomes a 3x2 matrix, and moreover, the BIJ is equal to AJI.",
...
"And that equal to this, which is a two one, second row first column, right, which is equal to two",
"and some [It should be 3] of the example B 3 2, right,",
"that's B 3 2 is this element 9, and that's equal to a two three which is this element up here, nine.",
...
"So by now hopefully you know how to add and subtract matrices as well as multiply them",
"and you also know how, what are the definitions of the inverses and transposes of a matrix",
"and these are the main operations used in linear algebra for this course.",
"In case this is the first time you are seeing this material.",
"I know this was a lot of linear algebra material all presented very quickly and it's a lot to absorb",
"but if you there's no need to memorize all the definitions",
"we just went through and if you download the copy of either these slides or of the lecture notes from the course website.",
...
"We'll be able in the next few videos to develop more powerful forms of linear regression that can view of a lot more data, a lot more features, a lot more training examples and later on after the new regression",
"we'll actually continue using these linear algebra tools to derive more powerful learning algorithims as well",
]