...
"In linear progression, we have a training set that I showed here",
"remember on notation M was the number of training examples,",
"so maybe m equals 47.",
...
"If theta0 = 0, theta1 = 0.5, then the hypothesis will look like this, and it should pass through this point 2,1 so that you now have h(x).",
...
"something i = 1 to m, of the square difference between, this is the prediction of my hypothesis when it is input to size of house number i.",
"Right? Minus the actual price that house number I was sold for, and I want to minimize the sum of my training set,",
"sum from I equals one through M, of the difference of this squared error, the square difference between the predicted price of a house, and the price that it was actually sold for.",
...
"And to make some of our, make the math a little bit easier, I'm going to actually look at we are 1 over m times that",
"so let's try to minimize my average minimize one over 2m.",
"Putting the 2 at the constant one half in front, it may just sound the math probably easier",
"so minimizing one-half of something, right, should give you the same values of the process, theta 0 theta 1, as minimizing that function.",
...
"And this notation, minimize over theta 0 theta 1, this means you'll find me the values of theta 0 and theta 1 that causes this expression to be minimized",
"and this expression depends on theta 0 and theta 1, okay?",
"So just a recap. We're closing this problem as, find me the values of theta zero and theta one so that the average, the 1 over the 2m, times the sum of square errors between my predictions on the training set minus the actual values of the houses on the training set is minimized.",
...
"And what I want to do is minimize over theta0 and theta1. My function j(theta0, theta1).",
"Just write this out. This is my cost function.",
"So, this cost function is also called the squared error function.",
"When sometimes called the squared error cost function and it turns out that why do we take the squares of the erros.",
