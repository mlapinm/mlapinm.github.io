...
"On your photo, right-click on\"Get Inf\" or\"Properties\" This will give you the photo's metadata, which may tell you the type of file it is; the date and time it was taken; the geolocation, or where it was taken; what kind of device was used to take the photo; and much more.",
"Pretty amazing, right?",
"Here's another example.",
"Every time you send or receive an email, metadata is sent right along with that message.",
"You can find it by clicking on\"Show Origina\" or\"View Message Details\" An email message's metadata includes its subject, who it's from, who it's to, and the date and time it was sent.",
