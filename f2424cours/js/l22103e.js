...
"Let's say your email program watches which emails you do or do not mark as spam.",
...
"You might also hear other ghost terms such as reinforcement learning and recommender systems.",
"These are other types of machine learning algorithms that we'll talk about later.",
"But the two most use types of learning algorithms are probably supervised learning and unsupervised learning.",
"And I'll define them in the next two videos and we'll spend most of this class talking about these two types of learning algorithms.",
...
"Teaching about learning algorithms is like giving a set of tools.",
...
"So what we're going to do in this class is actually spend a lot of the time talking about how if you're actually trying to develop a machine learning system, how to make those best practices type decisions about the way in which you build your system.",
