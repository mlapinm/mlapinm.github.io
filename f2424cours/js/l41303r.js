...
"И если вы посмотрите немного дальше, вы увидите, что есть якорный тег, весь якорный тег - это весь тег от a до /a lists.htm.",
...
"И так это index.",
"htm, а index.",
"htm прямо там и lists.htm.",
"И поэтому, если я нажму здесь, я перейду к lists.htm, и это вытащит этот другой файл вверх.",
...
"И теперь я вернусь, потому что это просто относительная ссылка, к lists.htm, чтобы я мог вернуться и посмотреть на следующее.",
"Давайте посмотрим, как изображены изображения.",
"Так что это просто абзац, в котором есть изображение.",
"Итак, это абзац, но есть изображение, src\"medium.jpg», если вы посмотрите в моей папке.",
"Если вы посмотрите в мою папку, вы видите изображение прямо там, medium.png.",
...
"И поэтому, если я нажму на это, он вернется к lists.htm.",
"И вы заметите, что все они возвращаются к lists.htm, так что я могу работать над следующим делом, верно?",
"Столы.",
...
"И снова, вы увидите разницу между объектной моделью документа",
"Когда вы отлаживаете эти вещи, вам придется иногда просматривать исходный код.",
...
"А позже в классе мы напишем код, который фактически изменит объектную модель документа",
"Так что давайте изменим это.",
