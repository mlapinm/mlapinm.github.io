...
"and we're not told what each data point is.",
...
"and if you have not seen this before, you can actually go to this URL news. google.com to take a look.",
...
"Here's a Wall Street Journal article about, you know, the BP Oil Well Spill stories of "BP Kills Macondo",",
"which is a name of the spill and if you click on a different URL from that group",
"then you might get the different story.",
"Here's the CNN story about a game, the BP Oil Spill,",
"and if you click on yet a third link, then you might get a different story.",
...
"So given knowledge about which friends you email the most or given your Facebook friends or your Google+ circles, can we automatically identify which are cohesive groups of friends,",
"also which are groups of people that all know each other?",
"Market segmentation.",
...
"And we're going to put two microphones in the room",
"so there are microphones, and because these microphones are at two different distances from the speakers, each microphone records a different combination of these two speaker voices.",
"Maybe speaker one is a little louder in microphone one and maybe speaker two is a little bit louder on microphone 2 because the 2",
"microphones are at different positions relative to the 2 speakers, but each microphone would cause an overlapping combination of both speakers' voices.",
...
"So we can do, is take these two microphone recorders and give them to an Unsupervised Learning algorithm called the cocktail party algorithm, and tell the algorithm - find structure in this data for you.",
...
"Moreover, what the cocktail party algorithm will do is separate out these two audio sources that were being added or being summed together to form other recordings and,",
"in fact, here's the first output of the cocktail party algorithm.",
...
"Not too bad, to give you one more example, here's another recording of another similar situation,",
"here's the first microphone : One, two, three, four, five, six, seven, eight, nine, ten.",
...
"It seems like in order to, you know, build this application, it seems like to do this audio processing you need to write a ton of code or maybe link into like a bunch of synthesizer Java libraries that process audio,",
"seems like a really complicated program, to do this audio, separating out audio and so on.",
...
"Octave, is free open source software,",
"and using a tool like Octave or Matlab, many learning algorithms become just a few lines of code to implement.",
...
"What I've seen after having taught machine learning for almost a decade now, is that, you learn much faster if you use Octave as your programming environment, and if you use Octave as your learning tool and as your prototyping tool,",
"it'll let you learn and prototype learning algorithms much more quickly.",
...
"So, I know that as an instructor, I get to say "trust me on this one" only a finite number of times, but for those of you who've never used these Octave type programming environments before, I am going to ask you to trust me on this one,",
"and say that you, you will, I think your time, your development time is one of the most valuable resources.",
...
"The news story example, that's exactly the Google News example that we saw in this video,",
"we saw how you can use a clustering algorithm to cluster these articles together",
...
"Only instead of, you know, good and bad cancer tumors or benign or malignant tumors we instead have diabetes or not",
"and so we will use that as a supervised, we will solve that as a Supervised Learning problem just like we did for the breast tumor data.",
"So, that's it for Unsupervised Learning",
"and in the next video, we'll delve more into specific learning algorithms and start to talk about just how these algorithms work and how we can, how you can go about implementing them.",
]