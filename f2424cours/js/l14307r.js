...
"Итак, в этом видео я покажу вам, как SQL может помочь вам в этом. включая удаление дубликатов,а также четыре функции, которые помогут вам очистить строковые переменные.",
...
"Возможно, вы помните, что мы уже говорили о текстовых строках как о группе символов. внутри ячейки, обычно состоящей из букв, цифр или того и другого.",
...
"Нам все еще нужно решить эту проблему, чтобы мы могли получить список всех клиентов. в США, в том числе два, которые имеют США вместо США.",
...
"Мы собираемся использовать функцию подстроки, чтобы получить первые две буквы каждой строки. страна так, чтобы все они были согласованы и содержали только две буквы.",
...
"Когда мы запускаем этот запрос, мы получаем список всех идентификаторов клиентов клиентов. чья страна США, включая клиентов, у которых США вместо США.",
...
"Далее мы рассмотрим другие способы работы со строками. и более продвинутые функции очистки.",
