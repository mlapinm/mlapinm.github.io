...
"This is ours.",
"Browsers have their own defaults, so display block, font size 2em, which is twice as big as the rest of the font, etc., etc.",
...
"It's just a set of selectors and then a select of key values we want color blue, border style, border color, etc., etc., etc.",
