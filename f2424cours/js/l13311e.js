...
"Click the\"Add Dat\" button in the upper right of the menu.",
...
"We can then move back to the Editor tab we have opened, or click\"Compose new quer\" to begin writing with SQL.",
...
"On this page, we can click\"Quer\" to automatically create a new editor window with the template for a query already populated.",
...
"Under Source and create table from, select\"Uploa\" or whichever method you prefer to upload your data.",
