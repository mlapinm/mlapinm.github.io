...
"so we had this formed as a hypothesis with these parameters theta zero and theta one,",
"and with different choices of the parameters we end up with different straight line fits.",
"So the data which are fit like so, and there's a cost function, and that was our optimization objective.",
"[sound] So this video, in order to better visualize the cost function J, I'm going to work with a simplified hypothesis function, like that shown on the right.",
...
"So, notice that the hypothesis, right, H of X. For a face value of theta one, this is a function of X.",
...
"On the left, let's say here's my training set with three points at (1, 1), (2, 2), and (3, 3).",
...
"And I'm gonna point out, when I'm plotting my hypothesis function. X-axis, my horizontal axis is labeled X, is labeled you know, size of the house over here.",
...
"Some from, some of 'em are training sets of this usual squared error term.",
"And, this is therefore equal to. And this. Of theta one x I minus y I and if you simplify this turns out to be. That. Zero Squared to zero squared to zero squared which is of course, just equal to zero.",
"Now, inside the cost function. It turns out each of these terms here is equal to zero.",
"Because for the specific training set I have or my 3 training examples are (1, 1), (2, 2), (3,3).If theta one is equal to one.",
"Then h of x. H of x i.",
"Is equal to y I exactly, let me write this better.",
"Right?",
"And so, h of x minus y, each of these terms is equal to zero, which is why I find that j of one is equal to zero.",
"So, we now know that j of one Is equal to zero.",
"Let's plot that.",
"What I'm gonna do on the right is plot my cost function j.",
"And notice, because my cost function is a function of my parameter theta one,",
"when I plot my cost function, the horizontal axis is now labeled with theta one.",
...
"So what if theta-1 is equal to 0.5.",
"What happens then?",
...
"So that is going to be one over 2M of, my usual cost function.",
...
"Cause just this vertical distance, that's the difference between, you know, Y.I. and the predicted value, H of XI, right?",
...
"And then finally, plus. 1.5 minus three squared.",
"And so that's equal to one over two times three.",
...
"So now we know that j of 0.5 is about 0.68.",
"[Should be 0.58] Lets go and plot that.",
"Oh excuse me, math error, it's actually 0.58.",
"So we plot that which is maybe about over there.",
"Okay?",
"Now, let's do one more.",
"How about if theta one is equal to zero, what is J of zero equal to?",
...
"We have that J of zero is equal to one over two M, times one squared plus two squared plus three squared, which is, One six times fourteen which is about 2.3.",
...
"It turns out that you can have you know negative values of theta one as well so if theta one is negative then h of x would be equal to say minus 0.5 times x then theta one is minus 0.5",
"and so that corresponds to a hypothesis with a slope of negative 0.5.",
...
"And by computing the range of values, you can actually slowly create out. What does function J of Theta say and that's what J of Theta is.",
...
"Whereas theta one=0.5. And this point shown in magenta corresponded to maybe that line, and theta one=zero which is shown in blue that corresponds to this horizontal line.",
...
"Now you remember, the optimization objective for our learning algorithm is we want to choose the value of theta one. That minimizes J of theta one.",
"Right?",
...
"So, to wrap up.",
"In this video, we looked up some plots. To understand the cost function.",
...
"In the next video. We'll go back to the original problem formulation and look at some visualizations involving both theta zero and theta one.",
"That is without setting theta zero to zero.",
