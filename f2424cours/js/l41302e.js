...
"And you'll note that that is a purple link because I have already been there because page1.htm was exactly where I just came from.",
"And so you click on that and you can go back and forth.",
"And those are the pages we played with in the HTTP lecture.",
"And so these absolute references are references that start with http or https or whatever, and relative references don't and so that basically means that this page1.htm file has to be in the same folder as whatever file we happen to be viewing right now on the same server.",
...
"So if you click right there, that will move you to lists.htm.",
...
"And so you can see that I have li to end li, li to end li, I'm putting some links in here, etc., etc.So dot dot dot dot dot.",
