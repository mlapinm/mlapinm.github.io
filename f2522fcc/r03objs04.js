let objs04 = [
 ...
 },
 {
  ...
  "code": [
   ...
   "  render() {",
   "    return (",
   "      <div style={{color: 'red', fontSize: 72, backgroundColor: 'yellow', padding: 12, borderRadius: 48, border: '3px solid blue'}}>Big Red</div>",
   "    );",
   "  }",
   "};",
   ""
 ...
 },
 {
  ...
  "code": [
   ...
   "  }",
   "  render() {",
   "    const usersOnline = this.state.users.filter((e) => e.online); // Change this line",
   "    let k = 0",
   "    const renderOnline = usersOnline.map((e) => {",
   "      return (",
   "        <li key={k++}>{e.username}</li>",
   "      )",
   "    }); // Change this line",
   "    return (",
   "      <div>",
 ...
 },
 {
  ...
  "code": [
   ...
   "https://www.youtube.com/watch?v=-pJN9faoa8E",
   ""
  ]
 }
]
