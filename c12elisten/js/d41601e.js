var d41601e = [
  "<a href=\"https://www.youtube.com/watch?v=AeOU7NNgeQg&list=PLVe_HgNacfDt289Fix3T3DS3EFQ1JJZ0N\">Uh…</a>",
  "Uh….",
  "Hmm. Um….",
  "Um….",
  "Uh….",
  ...
  "Um….",
  "Um….",
  "-Ah, good morning, Michael. -Good morning, sir.",
  ...
  "-Come on, come on. Sexual intercourse… -…intercourse.",
  ...
  "came to be using language like that in front of his mother.",
  ...
  "-About what? -I came here today to make a complaint.",
  "about my son being exposed to gutter language in the playground.",
  "I am frankly staggered.",
  "to find that this is something he's actually been taught in a classroom.",
  "-What is going on here? -Well, we're trying to teach your son….",
  "Oh, are you indeed? Trying to teach him what?.",
  "How to embarrass his parents? How to smack himself with heroine? What?.",
  "-Mr Smear, I can assure you, we have no… -Call yourself a school?.",
  "Well, I don't actually call myself a school, no.",
  "You ought to be ashamed of yourself.",
  "Filling a young lad's head with filth like that. Well, let me tell you something.",
  "about the real world. You're here to provide a service.",
  "-That's quite right. -Oh, “that's quite right.”.",
  "Well, I'm not happy with it. I'm not happy with the service you're providing.",
  "Would you rather that Michael didn't attend biology classes?.",
  "Well, certainly I would.",
  "if those are the kind of lies I can expect to hear repeated at the dinner table.",
  "-They're not lies, Mr Smear. -Oh, aren't they?.",
  "Aren't they? What, sexual intercourse can bring about pregnancy in the adult female?.",
  ...
  "I can assure you, Mr Smear, that sexual reproduction.",
  "has been part of the biology syllabus for many years.",
  "I don't care about your blasted syllabus.",
  "-What good is a blasted syllabus out there? -Out where?.",
  "-Out there. -The Arkwright Road?.",
  ...
  "-Casilingua. -Casilingua.",
  "Values. Respect. Decency. Standards.",
  "That's what you're here for. You're not here to poison my son with a lot of randy sex talk.",
  "Michael definitely is your son, is he?.",
  "Well, certainly he's my son.",
  "Then it's safe to assume that at some stage.",
  "you and Mrs Smear must've had sexual intercourse.",
  "Right. That's it.",
  "I've had enough of this. I'm gonna knock some sense into you myself.",
  "-You're gonna fight me now, are you? -Yes, I bloody well am.",
  "-I'm not gonna stand for this. -Well, do you mind if I do?.",
  "Talking like that in front of the boy. You're a bloody disgrace.",
  "Mr Smear, how can Michael be your son.",
  "if you and Mrs Smear have not had sexual intercourse?.",
  "-Michael is my son… -Yes?.",
  ...
  "-to get married. -Mmm-hmm.",
  "Uh, buy a house, get properly settled in, uh, furniture and so on.",
  "And, um… And just wait for a bit.",
  "Ah.",
  "Make sure you eat properly. Three hot meals a day.",
  "-Three hot meals? -Hot meals. Yes.",
  "Right. And Michael just sort of, um, popped up, did he?.",
  ...
  "Yes, it's very hard for you to believe, isn't it? It's very hard for you to believe.",
  "that there are still some of us who can bring a child to this world.",
  "without recourse to cannabis and government handouts.",
  "-Well, I really don't know what to say. -No, I bet you don't.",
  ...
  "-Well, it's perfectly obvious, isn't it? -Not to me.",
  "Well, I mean, if I go to Littlewoods.",
  "and say that I'm not happy with a cardigan, for example,.",
  ...
  "that these locusts will not embarrass Mrs Smear at table with foul language?.",
  "I think I can go that far.",
  "-Hmm. How many of them are they? -Well, there are two at the moment.",
  "What do you mean, at the moment?.",
  "Ah.",
  "Well, um, they're married, you see, and they've bought their own cage,.",
  "and some furniture, and have settled down and are having three meals a day.",
  "-Hot meals? -Warmish.",
  ...
  "“To fall and lie and change again Without a care or mind at all.",
  ...
  "Hugh, you chose that poem. Um, for God's sake, why?.",
  "I chose it for a number of reasons, Stephen.",
  "-Chief amongst them being? -Well….",
  "Can I perhaps turn that question round and say, “Because it was short”?.",
  "-The poem? -Yes.",
  "And that's important?.",
  "Well, yes, it seems to me, with the pace of modern life being what it is,.",
  "most people just haven't got time to spend on long poems.",
  "Therefore, this is something that would ideally suit.",
  "the short-haul commuter or the busy housewife.",
  "and leave plenty of time over for other sporting and leisure activities.",
  ...
  "-Oh, good heavens, yes. -Good heavens, yes?.",
  "-Good heavens, yes. -Oh.",
  "There's a poem by Richard Maddox called Institutions which I can read for you if you like?.",
  "-Please. -Right.",
  "“Li.”.",
  "-That is short. -It's very short. Yes.",
  "-Too short, perhaps? -Possibly.",
  "Nonetheless, it might suit, say, the very busy senior executive.",
  "who's only got a few moments to snatch between meetings and so on.",
  "Well, that of course is the market that Maddox was aiming for.",
  "Right. Now, round about this time, a lot of people are starting to think.",
  "about going on summer holidays.",
  "Do you have any advice as to the kind of poems that might be suitable, say,.",
  "for a family about to embark on a budget-bargain break weekend,.",
  "fortnight getaway day now?.",
  "Well, can I first of all issue a warning to any family.",
  "planning to take poetry on holiday with them?.",
  "-And that warning is? -Be careful.",
  "Oh, that sounds like good advice.",
  "Check with your travel agent to see if there are specific customs regulations regarding poetry.",
  "and if you're travelling outside the EEC, wrap up warm.",
  "Right.",
  "Do you have any particular advice on how to carry poetry abroad?.",
  "Ah, yes, now, I would say it's definitely worth investing.",
  ...
  "Right. Now, I believe you've got one more poem that you're going to read to us.",
  "-before you go away from here. -That's right.",
  ...
  "just about to start out in the catering business in the North Wales area?.",
  "Perfect.",
  ...
  "of all the vices that can destroy a young person's life.",
  ...
  "that decent, civilised behaviour is every bit as important.",
  "as being able to subtract or take away.",
  "Basically, the plain and simple purpose of education.",
  "must be to teach children, young people, not, I repeat, not….",
  "to break into my car.",
  "There will be other aspects to education, I'm sure,.",
  "but the most fundamental principle of decent, civilised behaviour is.",
  ...
  "Community service, such a favourite with magistrates in recent years,.",
  "shouldn't be a matter of simply scrubbing graffiti off a few lavatory walls.",
  "Young offenders must expect a short, sharp lesson.",
  "in replacing the nearside window of my car.",
  "Because leaving my bloody car alone is what this government means.",
  ...
  "-Well, yes, all right. -That's better. So, height?.",
  "-9′ 6″. -9′ 6″.",
  "-Weight? -Three tons.",
  "-Really? -Well, a bit over.",
  "That's better. A bit over three tons.",
  "It's as well to be accurate on these matters. Saves complications later on.",
  "All right. Do you have any particular disabilities?.",
  "-I've got no sense of taste. -Uh-huh. What, in films? Music?.",
  "-Food. I can't taste food. -Oh, dear, that might be a bit of a problem.",
  "-Might that be a bit of a problem? -I just said it might be a bit of a problem.",
  "Never mind. Pressing on. Special skills of any kind?.",
  "-I look good in black. -Excellent.",
  "-How old are you? -Ten and a half.",
  "-Shoe size? -28.",
  "Any particular quirks?.",
  "Yes. I keep muddling up my shoe size and my height.",
  "I mean, my height and my shoe size. There, I've done it again.",
  "All right, all right. Are you good at small talk?.",
  "-What, weather and traffic? -That sort of thing.",
  "-Yeah. I can hold my end up. -Splendid. Splendid.",
  "How much do you know about the SAS?.",
  "-Well, not much, really. -Not really. Right.",
  "Well, the SAS was originally founded.",
  "to be a crack secret, elite secret and crack assault force.",
  "-to work behind enemy lines during World War II. -Right.",
  "Now, our role has changed substantially since that time.",
  "Now we are here primarily to act as a masturbatory aid.",
  "for various backbench MPs.",
  "I see.",
  "Yes, I'm afraid so. You see, it seems a lot of today's parliamentarians.",
  "are quite unable to achieve sexual gratification.",
  "without fantasising about the SAS, you see.",
  "So we have to go about the place being crack secret,.",
  "and assaulting and secret and crack all the time, and as elite as possible.",
  "just so these people can keep their marriages intact.",
  "-Doesn't sound very exciting. -No.",
  ...
  "Oh.",
  "-Yes? -Hello. Yes, I've just been looking for.",
  "a particular book in the sports section and it doesn't seem to be there.",
  "It's by Ted Cunterblast.",
  "and I think it's called The West Indies: A Nation of Cricketers.",
  "That'll be in the sports section.",
  "Yes, I've just tried that and it doesn't seem to be there.",
  "-Who's it by? -Ted Cunterblast.",
  "-The West Indies: A Nation of Cricketers? -That's the one.",
  "It's by Ted Cunterblast.",
  ...
  "The West Indians: A Nation of Cricketers by Ted Cunterblast.",
  "precisely as it was delivered to us.",
  ...
  "-I envy you, sir. I can never read a book twice. -Neither can I.",
  "-Makes me giddy. -Where's the rest of it?.",
  "-The rest of what? -Of this book.",
  "-Apart from everything else, it isn't true. -Oh, ha ha! Not true?.",
  "-Isn't it, sir? -No!.",
  ...
  "To be blunt,.",
  "I'm an Englishman who merely happens to be a librarian.",
  "If, God forbid, the day should come when I would have to choose.",
  "between being a librarian and being an Englishman….",
  "Yes, yes, I think I get the idea, yeah.",
  "Good. Because may I say that I find your continued efforts.",
  "to drag down and smear this country of ours to be frankly disgusting.",
  ...
  "-He's a knocker, that's what he is. -I agree with you, Mrs Pert.",
  "Oh, it's very easy to knock, isn't it? You with your snide university ways.",
  "-Snide University? -Or wherever it is you went.",
  "So often these days, sir, we see, don't we, these so-called clever people.",
  "who just can't wait to tear down and destroy.",
  "-And knock. -And knock, yes.",
  "But do they ever have anything to put in the place of things that they destroy? No.",
  "It's wanton destruction.",
  "-Nothing offered… -Well, yes, it's a bit of an exaggeration,.",
  "but sometimes you really have to wonder what's happening to this country, you do.",
  "Well, I started on the piano. Then I moved up onto the mantelpiece.",
  "Now, Mr Nude, you claim….",
  "That's right. Yes, I do claim. I do indeed claim. Yes, that's right.",
  "Yes, you claim to be able to bend spoons using psychic energy.",
  "Psychic energy. Yes, that is the method I have chosen to bend spoons with. Yes, that's right.",
  "-How long have you had this ability? -How long exactly, yes.",
  "That's absolutely correct. How long, yes, indeed.",
  "Well?.",
  "Thank you, you are very sympathetic. Sometimes it's difficult when people are not sympathetic.",
  "but you are sympathetic. Thank you.",
  "Yes. Can you do other things with spoons apart from bend them?.",
  "-I can do anything with a spoon. -Really?.",
  "Yes. You give me a spoon and I'll give you the whole world.",
  ...
  "-I'm not a freak, you know. -Yes. I realise that.",
  "Some people think that I am some kind of a circus freak. I'm not a freak.",
  "No, no, I'm sure no one here….",
  "“Freak!” they sometimes shout at me when I'm walking down the street.",
  "But I'm no freak.",
  "-That must be rather distressing. -Yes, it is.",
  "Thank you, you're very sympathetic. Yes, thank you.",
  "Right. Um, I….",
  "-Would you care to have a go? -Yes, I will bend the spoon now, yes, I will.",
  "Right. Well, ladies and gentlemen, Mr Nude is now going to bend this spoon.",
  "using psychic energy.",
  "Yes, now is when I'm going to bend. I'm going to bend the spoon now.",
  "-Right. Go ahead. -Right.",
  "I don't know if your cameras can get in close to see what has happened here,.",
  "but the spoon is very bent. If I show you an ordinary spoon,.",
  "you can see that this is now, it's extremely bent, there you go.",
  "Well, the spoon is certainly bent.",
  "Of course it is, of course it is bent. I bent it so of course it is bent.",
  "Yes, that much is clear and beyond argument.",
  "No, forgive me, I am very tired now. It is very tiring for me to bend spoons.",
  ...
  "-What are you saying? -Simply that….",
  "-What is this? -It's a bent spoon.",
  ...
  "I never claimed to able to bend them with my hands. That is your claim.",
  "Well, you certainly did bend it with your hand.",
  "Yeah, well, yes, maybe the psychic energy does flow through my hands.",
  "-But the fact is that the spoon is bent. Hmm? -Well, I can bend spoons with my hands.",
  ...
  "And do you know what I have in here now? The beginnings of hatred for you. Yes.",
  "Well, next week we shall be examining the claims of….",
  "If viewers in the Matlock and Buxton areas of Derbyshire.",
  "would like to check their cutlery drawers, they will find a bent spoon.",
  "and an unused Weetabix special offer coupon.",
  "Also, I can reveal that viewers in the town of Datchet over the age of 14.",
  "have a slight itch on their right thigh which they are scratching as I speak.",
  "Good night.",
  "Parper, parper….",
  ...
  "-Not for me. -No.",
  "Nor indeed, nor indeed for me, but Sir William, now Lord, Rees-Mogg,.",
  "the chairman of the Broadcasting Standards Council,.",
  ...
  "Now, we wouldn't want you to run off to Cornwall with the idea.",
  "that Sir William's remit with the Broadcasting Standards Council.",
  "is so sweeping as to be a kind of government thought police.",
  ...
  "which is completely free of gratuitous sex and violence.",
  ...
  "the boundaries of Lincolnshire where, I understand, it rained like a bitch?.",
  ...
  "-What? -The hair currently under advisement belongs to?.",
