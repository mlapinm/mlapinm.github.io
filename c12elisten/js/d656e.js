var d656e = [
  ...
  "After school many young people go to.",
  ...
  "Volunteer teachers work in different.",
  "ways",
  ...
  "Maybe they can't provide all the food.",
  "That they all need but they can help.",
  ...
  "Some farmers raise animals so that people can eat meat like chicken and.",
  "beef",
  "7",
  "Not enough food.",
  ...
  "This often means that they don't have.",
  "Enough to eat.",
  ...
  "Fair trade farmers usually sell their.",
  "Crops straight to stores and supermarkets so that the farmers get more money.",
  ...
  "Crops need water to grow and animals.",
  "Drink water.",
  ...
  "We drink water we use water to wash ourselves clothes and dishes and to clean the home.",
  "We also use water when we flush the.",
  "Toilet.",
  "10",
  "Working with water.",
  ...
  "People build reservoirs to store this.",
  "Water.",
  "They also build pipes to take it to.",
  "Different places.",
  ...
  "They also help to keep water in wells.",
  "And springs as clean as possible.",
  "Most of earth's water is salt water in the oceans or frozen into ice.",
