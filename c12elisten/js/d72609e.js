var d72609e = [
  "<a href=\"https://www.youtube.com/watch?v=BQxPl8fePCc&list=PLYTCvVDe9NCZ-E5pUFirAeRPdjDw4VANf\">kara you made straight a's on your report card</a>",
  "kara you made straight a's on your report card.",
  "honey that's great.",
  "why didn't you tell me.",
  "i guess because nothing i do.",
  "seems like big news with shining a van around.",
  ...
  "you are still on your way to the nfl.",
  ...
  "huh hey listen i wrote down a few things you might want.",
  "to say about your favorite coach.",
  ...
  "you know it's a shame that montgomery's won't be there for van's banquet.",
  "such a big day.",
  ...
  "hey dad.",
  "hey cowboy.",
  "listen bj's visiting her mom.",
  "so it's just us men tonight.",
  "cool.",
  "maybe you men can eat something.",
  "that doesn't come with fries and a toy this time.",
  "hey that's not all i feed them.",
  "on mondays i have buffalo wings and a shirley temple.",
  ...
  "me oh i've been working out here for years.",
  "really.",
  ...
  "that even years of selfishness and exercise.",
  "can't undo.",
  ...
  "yeah thanks mrs h.",
  "yeah thanks mrs h.",
  "i can't h enough how honored i am.",
  "by this honor.",
  ...
  "well it was so nice seeing benny last night.",
  "that i i thought i'd like to see him off to school.",
  "well you're just in time.",
  "have you had breakfast.",
  "not in five years.",
  "but look at you reba.",
  "what a marvel you are fizzly cooking for your children.",
  "well i tried skipping it but they chew on the furniture.",
  ...
  "oh yeah.",
  "you know it's true.",
  "what they say about the camera adding 10 pounds.",
  "mommy.",
  "fanny.",
  "shoot me.",
  ...
  "so very very long.",
  "mom make it stop.",
  "all righty then it's getting late time to go to school.",
  ...
  "but you know.",
  "i thought i'd just hang out here with you.",
  "and until van gets home.",
  "in eight hours.",
  "what do we do while our children are at school.",
  "well today i have to pay the bills.",
  "vacuum the stairs.",
  ...
  "that's what's wrong the seven grain bread.",
  ...
  "but maybe she's a little too much back in your life.",
  ...
  "you know with the hugs and the muffins and that and i.",
  "i just wanted a little of that for vani and me.",
  ...
  "i want to be there.",
  "i just don't know how to be there for him.",
  ...
  "after all my baby's having a baby.",
  "mine too.",
  "oh dear god.",
