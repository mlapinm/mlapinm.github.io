var d41602e = [
  "<a href=\"https://www.youtube.com/watch?v=NM8McyQCRYs&list=PLVe_HgNacfDt289Fix3T3DS3EFQ1JJZ0N&index=2\">Uh…</a>",
  "Uh….",
  "Uh….",
  "Well….",
  "Well….",
  ...
  "-Good morning. -Right. Can I help you?.",
  "Yes, your face, my arse.",
  "No, I said, “Can I help you?”.",
  "Oh, I see. Yes, I'd like some information, please.",
  "-Yes. -Well?.",
  "-Well what? -I'd like some information, please.",
  "-Yes, but what sort of information would you like? -Well, what sorts have you got?.",
  "-I beg your pardon? -What sorts of information have you got?.",
  "-Well, we have all sorts. -Such as?.",
  ...
  "-Right. What's the name… -Yes?.",
  "What's the name of the man who taught me English at school?.",
  "-I'm afraid that really isn't the kind of thing… -Ah! Ah! Yeah, here you are.",
  "All right, his name was Colin Drip.",
  "That's right.",
  "Drippy you used to call him.",
  "Drippy. God, that takes me back a bit.",
  "Oh, now, yeah, there was a bloke in our class, what was his name… Uh….",
  ...
  "-But you do have it? -Oh, yes.",
  "-But it's restricted? -That's right.",
  "-Contented? -Yes, thank you.",
  "No, have you got any information on how to be contented?.",
  "Oh, I see. Yes, we do have information on that.",
  "-Well, can I have it, please? -I'm afraid it is a secret.",
  "-Oh, go on. -All right.",
  ...
  "Oh, one of those news ones that gets black and white.",
  "Um, but I was away on business when we got married.",
  "and, um, we've both been so frantically busy since then.",
  "It doesn't have to be like this, you know.",
  "I know what she looks like, of course.",
  "-And the vehicle does belong to you, does it, sir? -Yes.",
  "-Were you driving it at the time? -Uh, yes, I was, yes.",
  "All right. If I could just have your name, please, sir.",
  ...
  "Mr…?.",
  "It's as it sounds.",
  "-Yeah, but if you wouldn't mind spelling it for me. -I mean, can't you….",
  "I would be very grateful if you would spell it for me.",
  "All right, then.",
  "N-I-P-P.",
  "L hyphen E.",
  "Nipple.",
  "-Beg your pardon? -Nipple.",
  ...
  "Or is it? Perhaps the law's changed since I last looked.",
  "Perhaps the Home Secretary has had to take stern measures against the rising tide.",
  "of people giving their address to policemen whenever they're asked.",
  "All right. All right.",
  ...
  "-As spoken by us. -As we speak it, yes, certainly. Defines it.",
  "Um, we are defined by our language, if you will.",
  "Hello, we're talking about language.",
  "Um, perhaps I can illustrate my point. Let me at least try.",
  "Um, here's a question.",
  "Um….",
  "-Oh, what is it? -Ah! Well, my question is this.",
  ...
  "-By demagoguery, I mean demagoguery. -I thought so.",
  "I mean, um,.",
  "highly charged oratory, persuasive, whipping-up rhetoric.",
  "Listen to me, listen to me.",
  "If Hitler had been British,.",
  "would we, under similar circumstances, have been moved, charged up, fired up.",
  ...
  "Um, may I compartmentalise? I hate to, but may I? May I?.",
  "Is our language a function.",
  "of our British cynicism, tolerance, resistance to false emotion, humour and so on,.",
  "or do those qualities come extrinsically,.",
  "extrinsically,.",
  "from the language itself? It's a chicken and egg problem.",
  ...
  "hundreds of new melodies, new tunes, new harmonies are being composed.",
  "upon hundreds of different keyboards everyday in Dorset alone.",
  "Now, our language, tiger, our language,.",
  "hundreds of thousands of available words,.",
  "frillions of legitimate new ideas,.",
  "so that I can say the following sentence and be utterly sure that nobody.",
  "has ever said it before in the history of human communication,.",
  ...
  "saying to each other the same things time after weary time.",
  "“I love you”, “Don't go in there”, “Get out”, “You have no right to say that”,.",
  "“Stop it”, “Why should I?”, “That hurt”, “Help”, “Marjorie is dead”.",
  "Hmm?.",
  ...
  "Oh, of course it is, of course it is, of course it is, of course it is.",
  "Um, language is my mother, my father, my husband, my brother, my sister,.",
  ...
  "as you pluck from an old bookshelf a half-forgotten book of erotic memoirs.",
  "Um….",
  ...
  "♫ America.",
  "♫ America ♫.",
  "Well, thank you. That was the Unmistakable Sound.",
  "All right, now, uh,.",
  "my next guest wrote his first novel way back in 1972,.",
  "uh, the year of flares, Suzi Quatro, the Glitter Band, all that stuff.",
  ...
  "Um, well, the novel I've just written is called The Emperor of Disgust.",
  "Emperor of Disgust? Well, that sounds pretty heavy.",
  "-Heavy? -Um, so, what's it about?.",
  "Well, haven't you read it?.",
  "Well, I mean, for the viewers at home. Obviously, they haven't read it.",
  "Well, how can they have done? It isn't published till tomorrow, is it, eh?.",
  ...
  "Yeah, yeah.",
  "-Basically… -Tell me, do you use a word processor?.",
  "It's something I've always wanted to know about writers.",
  "You know, do you use a pencil, pen, typewriter, what?.",
  "-I do use a word processor, yes. -Yeah, yeah.",
  ...
  "-Well, yes, I do. Yes, I take it very seriously. -Yeah.",
  "-It's my living, you see. It's my job. -Yeah.",
  ...
  "-Yeah? -Yes.",
  "I have to say, I think you're one of the most repellent.",
  "and flatulent-minded people I've ever met.",
  "In many respects, ideal fodder for a novelist.",
  "I don't know what you're laughing at. I find you vapid, irrelevant and a waste.",
  "Yeah, now, seriously, Richard….",
  "I am being serious. I am being serious, you repulsive ball of spittle.",
  "And who told you you could call me Richard, hm?.",
  "You know, I mean, you're rotting in hell and you haven't the first idea about it, have you?.",
  "-Now, uh, your last book… -My last book?.",
  "You don't know anything about any of the books I've written,.",
  "except what that daffy researcher you sent round tells you.",
  "Your head is so filled of pappy drivel.",
  "and greasy bigotry and, you know, crash-brash ignorance,.",
  "there's not room in it left for a single idea, is there?.",
  "This is brilliant.",
  "Oh, it's brilliant, is it? I suppose, it's good television, is it?.",
  "I suppose it shows you at the cutting edge of dangerous broadcasting.",
  ...
  "-He's supposed to know this, come on. -I'm sorry….",
  "-Let's have the script, script. Come on. -I'm sorry.",
  "Ten minutes, come on.",
  "-Oh, yes. -“The fat, smug git…”.",
  "-“Who's just won a BAFTA.” -Who's just won a BAFTA, right.",
  "Look at you sitting there like a fat, smug git who's just won a BAFTA.",
  "-Yeah. Have you any idea. -Have you any idea.",
  "how degrading and demeaning to the human spirit.",
  "-people like you are? -People like you really are.",
  "All right, I'll ask you, you know, where the book's on sale, how much it costs.",
  "Er… then we'll play you out. After that's a bit of chat, blah-di-blah-di-blah.",
  "Then what's next?.",
  "Hello, Control.",
  "Oh, hello, Tony.",
  "How are you today?.",
  ...
  "We've got quite a few important agents in Berlin, haven't we?.",
  "-So it might be something quite urgent, I expect. -Yes.",
  "I see Valerie has decoded it for me. That's very kind of her.",
  "Saves me quite a lot of work. I must remember to thank her.",
  "That would certainly be a nice gesture, sir.",
  "Well, I don't know if you had a chance to glance at this.",
  "before thoughtfully bringing it in to me, Tony.",
  "But, uh,.",
  "it's quite an urgent communication from Firefly, our network chief in Berlin.",
  ...
  "-So the whole network's been blown? -I'm afraid so.",
  ...
  "-Well, it couldn't hurt, could it? -No, not one.",
  ...
  "-Well, it's for the money. -Money?.",
  "What money? What are you talking about? What are you doing?.",
  ...
  "Just being kind? Just being kind? What do you mean, just being kind?.",
  "If they were just being kind, they'd put a bullet through your head, wouldn't they?.",
  "That's what I'd call being kind. Put you out of your misery.",
  ...
  "It's not the same planet at all. How dare you suggest otherwise?.",
  "Well, you may not think it's the same planet, but it is. You couldn't have one without the other.",
  "Couldn't have one without the other? What are you talking about?.",
  ...
  "Are you a communist? Do you want me to call a policeman?.",
  "It's not a crime to be a communist. Anyway, I'm not.",
  "Not a crime to be a communist?.",
  "Of course it's a crime to be a communist. This is 1989.",
  "Communists are the enemies of democracy.",
  "They should be locked away.",
  "-Well, what's so good about democracy? -What's so good about democracy?.",
  ...
  "Now, we use our hands so often in our everyday lives.",
  "that it's all too easy to take them for granted and just forget about them altogether,.",
  "and that can obviously be fairly dangerous.",
  "So first of all, as always, make sure you're absolutely comfortable.",
  ...
  "Damn it, Peter, I want answers and I want them fast.",
  ...
  "-Agreed. -So, shoot. What have we got?.",
  ...
  "Meaning?.",
  "Meaning they'll laugh in your face, John, like they did me.",
  "Marjorie's got them eating out of her hand.",
  "Then I'll go to old man Derwent himself.",
  "Oh, come off it, John.",
  "No one's even spoken to old man Derwent in years. The man's a recluse.",
  "It's over, I tell you. Marjorie's won and she hasn't even fired a shot.",
  "Listen to me, Peter.",
  ...
  "-Damn it. -What?.",
  "-What are you up to? -Something. I'm up to something.",
  "-I thought so. -I want you on my side for this, Peter.",
  "-I'm yours, John, you know that. -I haven't finished yet.",
  ...
  "Good to hear.",
  "Now, call O'Neill. Get him to postpone the meeting.",
  "What shall I tell him?.",
  "Tell him any damn thing you like. Just buy me some time.",
  "It's good to have you back, John.",
  "Save the pretty speeches till later on, Peter. We've got a long night ahead of us.",
  "-Just like old times, eh? -Sure, Peter, sure.",
  "You know, it's funny. I drove through High Wycombe just the other day.",
  "Yeah, it's Peter here. Get me O'Neill.",
  "-And fast. -And fast.",
  "Say again.",
  "-Damn it. -What?.",
  "O'Neill's out of town. Can't be reached.",
  "-Damn it to hell and back. -Damn blast and double damn.",
  "Damn.",
  "-Want me to try Amsterdam? -No.",
  "-But, I mean… -Come on, Peter, you're not thinking straight.",
  "Amsterdam is too obvious. Marjorie was never obvious.",
  ...
  "You don't need a Harvard MBA to know that the boardroom and the bedroom.",
  "are just two sides of the same agenda.",
  "I wonder….",
  "Try me. Shoot.",
  "Put it together.",
  "If we were to act fast,.",
  "a block of part-paid ordinaries funnelled through Geneva….",
  "a carefully staged pre-release of IDL preference stock through the back door,.",
  ...
  "A ploy like that? No. It'll have Seagrove's handwriting all over it.",
  "And back again.",
  "-But that still leaves us with Marjorie. -Yeah.",
  "Marjorie.",
  "What's she after?.",
  ...
  "you take the rough with the smooth, you do your best,.",
  "you cover all the angles, you never have enough time.",
  "You keep on grafting long hours, you think you know, but of course you don't.",
  "They talk about stress, I tell them I'm married to it.",
  "You have a daughter, I believe.",
  "Yeah. Yeah, Henrietta.",
  "Did he? Did he? I'm sorry to hear that.",
  "That….",
  "That must have hurt. That must've hurt like hell on a Jet Ski.",
  "You never had kids of your own, I believe.",
  "You're wrong, Peter. You're so damn wrong.",
  "-Oh, I beg your pardon. -You're standing in my children right now.",
  "I think I may have misheard that, John.",
  "-The company, Peter. -Oh, the company, yeah.",
  ...
  "New York will come through, John. I know they will.",
  "I hope so, I hope so.",
  ...
  "Damn it, I agree.",
  "-If New York rings, tell them affirmative. -Right.",
  "I'll get on to Susan.",
  "Now, let's get the hell out of here.",
  "-Are you sure? -Yeah, yeah, yeah.",
  "I don't think even we two can maintain.",
  "a level of intense work without coming down for a space.",
  "-Damn it, you're right. -Besides….",
