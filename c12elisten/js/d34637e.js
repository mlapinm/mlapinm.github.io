var d34637e = [
  "<a href=\"https://www.youtube.com/watch?v=RLtgbAoy27Q&list=PL2cSiRADbCEUjb6HVcKNjc2OTzBoK-6Bg&index=11\">Ted, have you seen my record collection?</a>",
  "Ted, have you seen my record collection?.",
  "- Record collection?.",
  "- Yeah.",
  "Here it is. And Dougal, you need more than one record to have a collection.",
  ...
  "- Practice!.",
  "- What?.",
  "That old joke - \"How d'you get to Carnegie Hall? Practice!\".",
  "Uh?.",
  "Oh, I-I see.",
  "Um, you'd have to go to New York, Dougal.",
  "Oh, right. Yeah. Ted... do you mind if I put on my record?.",
  "No. Go ahead.",
  "- I've got Eurosong fever, Ted.",
  "- Yeah?.",
  "God, yeah. I love the Eurosong competition. I can't wait.",
  "- What time is it now?.",
  "- Half past one.",
  ...
  "- 'What?'.",
  "Eurosong '96. The young fella has me driven mad with it.",
  ...
  "Ok. We'll call it...",
  "My Lovely Horse... by Father...Ted...Crilly.",
  ...
  "I want to rub my fingers through your tail and...love you all night.",
  ...
  "Right.",
  "Father Jack's right. It's a terrible song. What were we thinking?.",
  "It's not that bad, Ted.",
  "The lyrics are fine.",
  "There's no problem there.",
  "But it's a terrible tune. It's just the same note over and over again.",
  ...
  "Yeah. If only we'd come up with something like that.",
  "Dougal...I suppose not many people have actually heard that song?.",
  "Suppose not.",
  ...
  "No! You'd have to be mad to jump to that conclusiуn.",
  ...
  "- Four pounds!.",
  "Right! You're on!.",
  "That's just us winning. A million points is a bit of an exaggeration.",
  ...
  "So please put your hands together and welcome on stage.",
  "Euro hopefuls from Rugged Island,.",
  "Father Dick Byrne and Father Cyril McDuff!.",
  "# When I was young.",
  "# I had a dream.",
  ...
  "I suppose so. But I didn't think the audience were going for it.",
  "Yeah, yeah... Cheers!.",
  "What's going on?!.",
  ...
  "I think we will.",
  "Europe, here we come!.",
  "We'd better sneak them out the back. That's a nasty crowd out there.",
  "'Thank you, Athens.",
