let objs = [
  ...
  },
  {
    ...
    "ru": [
      "однако эти темы также есть в темах экзамена icnd2"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "однако на самом деле все эти настройки должны выполняться вручную из соображений безопасности."
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "g1 должен быть транком, поскольку он ведет к r1 для маршрутизации между VLAN"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "однако, поскольку DTP отключен, он не отправляет пакеты на коммутатор 2, поэтому динамический интерфейс пользователя G G коммутатора 2 также может стать магистралью"
    ]
  },
  {
    "time": [
