let objs = [
  ...
  },
  {
    ...
    "ru": [
      "Независимо от того, какой маршрутизатор является активным, маршрутизатор ответит своим собственным MAC-адресом."
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "час 1 снова станет активным, когда выздоровеет"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "Я просто подожду еще 10 секунд или около того, а затем пойду проверю"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "и разберемся, но скоро r2 должен стать активным, а r1 - резервным для VLAN 20, давайте сначала попробуем пинговать с ПК 3 Я попробую выполнить ping виртуального маршрутизатора, чтобы убедиться, что ping 10 20 21 хорошо, мы можем достичь его попробуйте выполнить ping на внешний сервер ping 1500 1 хорошо, он доступен, так что теперь давайте проверим путь, по которому он проходит traceroute 1501, поскольку вы можете видеть, что он проходит через r2 в 10.20 22 давайте снова протестируем аварийное переключение Я перезагружаю наш, чтобы завершить перезагрузку хорошо давайте дайте нашему одному несколько секунд, чтобы он стал активным для VLAN 20, хорошо, давайте попробуем, давайте вернемся на ПК 3 и снова проведем трассировку traceroute 1500 1 отлично, отработка отказа сработала, и теперь пинг проходит через r1 в 10.20 23, на этот раз давайте подождем еще 10 секунд или около того, чтобы r2 вернулся в сеть и снова взял на себя управление, поскольку активный маршрутизатор в порядке, надеюсь, этого достаточно, давайте дадим этому traceroute еще одну попытку здесь, на ПК три traceroute 1500 один хорошо, теперь он вернулся к использованию R 2 в качестве шлюза в в этой лабораторной работе мы настроили HS RP, а также sh узнал, как вы можете настроить балансировку нагрузки, настроив разные активные маршрутизаторы для разных VLAN, и все это для этой лабораторной работы. Спасибо за просмотр. Я надеюсь, что эта лабораторная работа и видео были полезны для вас. Подпишитесь на будущие лабораторные работы, подобные этой, которые будут выпускаться еженедельно запросы на любые конкретные лаборатории дайте мне знать в разделе комментариев, если вы хотите поддержать мой канал Я принимаю пожертвования биткойнами и эфириумом по адресам в описании Я также храбрый проверенный издатель и принимаю пожертвования биткойнов или токенов основного внимания в смелом браузере"
    ]
  }
]