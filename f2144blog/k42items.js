let objs = [
  ...
  },
  {
    ...
    "ru": [
      "Надеюсь, вы усвоили это во время учебы, если вы не знакомы с этим сейчас, убедитесь, что вы готовы к тесту"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "по одному для каждой из других внутренних сетей маршрутизаторов"
    ]
  },
  {
    "time": [
