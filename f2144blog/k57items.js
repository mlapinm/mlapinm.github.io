let objs = [
  ...
  },
  {
    ...
    "ru": [
      "следующий r3 включить интерфейс кофе / чая l0 IP-адрес 3 3 3 3 255 255 255 255 выход"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "но на самом деле мы не выполняли никаких команд из этого режима конфигурации"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "вы можете увидеть идею маршрутизатора v dot v dot v dot v, которая была унаследована от адреса ipv4 с нулями петли"
    ]
  },
  {
    "time": [
