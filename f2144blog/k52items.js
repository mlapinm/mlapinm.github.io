let objs = [
  ...
  },
  {
    ...
    "ru": [
      "один известен как маршрутизатор на флешке"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "и даже если бы это было так, было бы предпочтительнее, если бы коммутатор 1 протирал между самими виртуальными локальными сетями, не отправляя трафик на маршрутизатор."
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "давай включим первый и заставим его работать"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "имейте в виду, что я уже настроил интерфейсы коммутатора, подключенные к ПК один и ПК два, чтобы они были в VLAN 10 и VLAN 20"
    ]
  },
  {
    "time": [
