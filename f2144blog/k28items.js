let objs = [
  ...
  },
  {
    ...
    "ru": [
      "если вам нравятся эти лаборатории, пожалуйста, подумайте о поддержке меня через мой патреон, где в описании указаны параметры криптовалюты"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "Итак, давайте настроим рип на каждом из этих интерфейсов"
    ]
  },
  {
    "time": [
