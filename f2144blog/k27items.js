let objs = [
  ...
  },
  {
    ...
    "ru": [
      "в этой лабораторной работе мы рассмотрим протокол маршрутной информации, известный как rip"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "как вы можете видеть, r1 узнал не сети 10.0.1.0/24 и 10.0.2.0 / 24, а сеть 10.0.0.0 / 8 от r2"
    ]
  },
  {
    "time": [
