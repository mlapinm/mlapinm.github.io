let objs = [
  ...
  },
  {
    ...
    "ru": [
      "в отличие от предыдущей лабораторной работы, однако, мы также настроим аутентификацию, чтобы наши маршрутизаторы r2 и r3 работали только с надежным источником времени r1."
    ]
  },
  {
    "time": [
