let objs = [
  ...
  },
  {
    ...
    "ru": [
      "Однако я не буду настраивать его сейчас"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "означает, что все, что не относится к предыдущей записи в ACL, будет отклонено"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "нет, мы должны применить его к интерфейсу"
    ]
  },
  {
    "time": [
