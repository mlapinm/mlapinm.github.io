let objs = [
  ...
  },
  {
    ...
    "ru": [
      "затем процесс повторяется, и он перейдет от переключателя 1 2 переключателя 2 к переключателю 3 к переключателю 1 2 переключателя 2 к переключателю 3, а также то же самое в другом направлении"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "это все те же модели, поэтому давайте просто проверим первый переключатель"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "поэтому для VLAN 1 приоритетом является 3 2 7 6 9, который является приоритетом по умолчанию 3 2 7 6 8 плюс номер VLAN один."
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "ну, вы можете видеть на трассировщике пакетов, который заблокирован из-за индикаторов порта"
    ]
  },
  {
    "time": [
  ...
  },
  {
    ...
    "ru": [
      "связующее дерево VLAN 30 маршрут вторичный и, наконец, коммутируемый 2"
    ]
  },
  {
    "time": [
